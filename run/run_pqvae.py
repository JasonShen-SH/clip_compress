...
if __name__ == '__main__':
    ...
    full_features, full_labels = torch.load("data/features_labels/test_features_labels.pt", map_location = device) 
    ...
    # save model
    model_save_path = "latest_models/pqvae_seperate"
    ...
    while epoch < args.epoch:
        ...
        if test_accuracy > highest_test_accuracy:
            ...
            # torch.save(model.state_dict(), os.path.join(model_save_path, f"{args.bw}-n_e-{args.n_e}.pt"))
        epoch += 1
