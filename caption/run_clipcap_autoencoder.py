...
if __name__ == '__main__':
    ...
    encoder_output_dimension = 20
    levels = 16
    print(f"encoder_output_dimension-{encoder_output_dimension}-levels-{levels}")
    ...
    model_pretrain.load_state_dict(torch.load(f"latest_models/improved_fsr/encoder-output-dimension-{encoder_output_dimension}-levels-{levels}.pt", map_location=device))
    ...
    output_dir = "clipcap_autoencoder"
    os.makedirs(output_dir, exist_ok=True)
    subfolder_dir = os.path.join(output_dir, "ft_all_new")
    os.makedirs(subfolder_dir, exist_ok=True)
    subsubfolder_dir = os.path.join(subfolder_dir, f"encoder_output_dimension-{encoder_output_dimension}-levels-{levels}")
